...
public class UserService {
	...
	public void addSkills(MentorSkills mentorSkills, String mentorName, String skillName)
			throws UserAlreadyExistsException, SkillAlreadyAddedException {
		...
		System.err.println("mentor id" + mentorId);
